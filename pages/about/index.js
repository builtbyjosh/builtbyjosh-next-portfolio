...
import { Box, Text, Stack, SimpleGrid, Container } from "@chakra-ui/react";
      ...
      <Container maxW="2xl" p={2}>
        <Stack textAlign={"left"} color={"primary.500"} spacing={5}>
          ...
          <Text>
            ...
            Schools Software Engineering Coding Bootcamp. Shortly after
            completing my bootcamp, I landed my first role as a Frontend
            Developer. And had to quickly get up to speed working with
            TypeScript and Chakra-UI, neither of which I had ever worked with
            before.
          </Text>
          <Text>
